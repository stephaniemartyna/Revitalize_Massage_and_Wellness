...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://m.facebook.com/p/Revitalize-Massage-Wellness-100086483143748/',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/revitalizemassagewellness/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer className="bg-white drop-shadow-portfolio">
