        ...
        <div className="container">
          ...
          <Swiper slidesPerView={1} ref={sliderRef}>
            <SwiperSlide>
              <SingleTestimonial
                image={Client1}
                details="Had the most amazing massage experience with Brooklyn! Her hands worked absolute wonders on my knots and tension. Definitely, my go-to spot for some much-needed R&R! !"
                name="Jane Doe"
                position="Client."
              />
            </SwiperSlide>
            <SwiperSlide>
              <SingleTestimonial
                image={Client2}
                details="Just had the most incredible massage from Brooklyn - seriously a game-changer! Her skills are off the charts, and the vibe is so chill, like hanging out with a friend who happens to be a massage wizard!"
                name="Samantha Smith"
                position="Client."
              />
            </SwiperSlide>
